...
const features = [
  'Access your account lists',
  'View your partner connections',
...
function LoginContent() {
  ...
  return (
    <div className="min-h-screen flex lg:h-screen lg:overflow-hidden">
      ...
      <div className="hidden lg:flex lg:h-screen lg:w-120 xl:w-130 shrink-0 bg-linear-to-br from-indigo-600 via-indigo-700 to-violet-800 relative overflow-hidden flex-col justify-center px-12 xl:px-16">
        ...
        <div className="relative">
          ...
          <p className="text-indigo-200 text-lg mb-12 max-w-sm leading-relaxed">
            Sign in to continue finding account overlaps with your partners.
          </p>
      ...
      {/* Form Panel */}
      <div className="flex-1 min-h-screen lg:h-screen bg-linear-to-br from-indigo-50 via-white to-sky-50 lg:bg-slate-50/80 flex items-center justify-center p-4 sm:p-8 lg:overflow-y-auto">
        <motion.div
